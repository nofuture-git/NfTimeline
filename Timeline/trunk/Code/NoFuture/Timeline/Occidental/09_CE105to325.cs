namespace NoFuture.Timeline
{
    public partial class Occidental
    {
        public Plate CE105to325()
        {
            ...
            rome.AddEntry(new LeaderEntry("Hadrian", new int?[,] { { 117, 138 } }) { StartValue = 117, Location = PrintLocation.Right });
            rome.AddEntry(new LeaderEntry("Antoninus Pius", new int?[,] { { 138, 161 } }) { StartValue = 138, Location = PrintLocation.Right });
            ...
            rome.AddEntry(new LeaderEntry("Marcus Aurelius", new int?[,] { { 161, 180 } }) { StartValue = 161, Location = PrintLocation.Right });
            ...
            west.AddEntry(new LeaderEntry("Pope Alexander I", new int?[,] { { 107, 115 } }) {StartValue = 107, Location = PrintLocation.Right});
            west.AddEntry(new LeaderEntry("Pope Xystus", new int?[,] { { 115, 125 } }) { StartValue = 117, Location = PrintLocation.Right });
            west.AddEntry(new LeaderEntry("Pope Telesphorus", new int?[,] { { 125, 138 } }) { StartValue = 127, Location = PrintLocation.Right });
            west.AddEntry(new LeaderEntry("Pope Hyginus", new int?[,] { { 138, 140 } }) { StartValue = 140, Location = PrintLocation.Right });
            west.AddEntry(new LeaderEntry("Pope Pius", new int?[,] { { 142, 155 } }) { StartValue = 144, Location = PrintLocation.Right });
            west.AddEntry(new LeaderEntry("Pope Anicetus", new int?[,] { { 155, 166 } }) { StartValue = 157, Location = PrintLocation.Right });
            west.AddEntry(new LeaderEntry("Pope Soter", new int?[,] { { 166, 175 } }) { StartValue = 168, Location = PrintLocation.Right });
            west.AddEntry(new LeaderEntry("Pope Eleuterus", new int?[,] { { 175, 189 } }) { StartValue = 177, Location = PrintLocation.Right });
            west.AddEntry(new LeaderEntry("Pope Victor I", new int?[,] { { 189, 199 } }) { StartValue = 191, Location = PrintLocation.Right });
            west.AddEntry(new LeaderEntry("Pope Zephyrinus", new int?[,] { { 199, 217 } }) { StartValue = 201, Location = PrintLocation.Right });
            west.AddEntry(new LeaderEntry("Pope Callixtus", new int?[,] { { 217, 222 } }) { StartValue = 219, Location = PrintLocation.Right });
            west.AddEntry(new LeaderEntry("Pope Urban", new int?[,] { { 222, 230 } }) { StartValue = 222, Location = PrintLocation.Right });
            west.AddEntry(new LeaderEntry("Pope Pontian", new int?[,] { { 230, 235 } }) { StartValue = 233, Location = PrintLocation.Right });
            west.AddEntry(new LeaderEntry("Pope Anterus", new int?[,] { { 235, 236 } }) { StartValue = 236, Location = PrintLocation.Right });
            west.AddEntry(new LeaderEntry("Pope Fabian", new int?[,] { { 236, 250 } }) { StartValue = 239, Location = PrintLocation.Right });
            west.AddEntry(new LeaderEntry("Pope Sixtus II", new int?[,] { { 257, 258 } }) { StartValue = 257, Location = PrintLocation.Right });

            west.AddEntry(new HeresyEntry("Marcionism", "Old Test. false") {StartValue = 150});
            west.AddEntry(new PhilosopherEntry("Irenaeus", 130, 202) {StartValue = 156, Location = PrintLocation.Left});
            west.AddEntry(new LiteraryWorkEntry("Against Heresies", "Irenaeus") { StartValue = 180 });
            west.AddEntry(new PhilosopherEntry("Cyprian of Carthage", 200, 258) { StartValue = 230, Location = PrintLocation.Left});
            west.AddEntry(new PhilosopherEntry("Tertullian", 160, 225) { StartValue = 210, Location = PrintLocation.Left });
            west.AddEntry(new LiteraryWorkEntry("Apologeticus", "Tertullian") { StartValue = 193 });
            west.AddEntry(new HeresyEntry("Valentinians", "Aeons") { StartValue = 175 });
            ...
            east.AddEntry(new PhilosopherEntry("Justin Martyr", 100, 165) { StartValue = 130, Location = PrintLocation.Left });
