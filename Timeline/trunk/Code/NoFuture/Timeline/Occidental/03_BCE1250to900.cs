namespace NoFuture.Timeline
{
    public partial class Occidental
    {
        public Plate BCE1250to900()
        {
            ...
            palestine.AddEntry(new ProphetEntry("Samuel") {StartValue = 1030});
            palestine.AddEntry(new LeaderEntry("Saul", new int?[,] {{1020, 1000}}) {StartValue = 1010});
            palestine.AddEntry(new LeaderEntry("David", new int?[,] {{1000, 961}}));
            ...
            assyria.AddEntry(new LeaderEntry("Tukulti-ninurta I", new int?[,] {{1234, 1197}}));
            assyria.AddEntry(1180, "Assyrian weakness");
            assyria.AddEntry(1100, "(brief Assyrian revival)");
            assyria.AddEntry(new LeaderEntry("Tiglath-pileser I", new int?[,] {{1116, 1078}}));
