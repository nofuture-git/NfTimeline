namespace NoFuture.Timeline
{
    public partial class Occidental
    {
        public Plate CE1075to1350()
        {
            ...
            engd.AddEntry(new LeaderEntry("William II", new int?[,] { { 1085, 1100 } }) {StartValue = 1087});
            engd.AddEntry(new LeaderEntry("Henry I", new int?[,] { { 1100, 1135 } }));
            engd.AddEntry(1135, 1150, "The Anarchy(1135-1154)");
            engd.AddEntry(new LeaderEntry("Henry II", new int?[,] { { 1154, 1189 } }) { StartValue = 1159});
            engd.AddEntry(new LeaderEntry("Richard I", new int?[,] { { 1189, 1199 } }));
            engd.AddEntry(new LeaderEntry("John", new int?[,] { { 1199, 1216 } }));
            engd.AddEntry(1219, "Magna Carta(1215)", PrintLocation.Right);
            engd.AddEntry(new LeaderEntry("Henry III", new int?[,] { { 1216, 1272 } }) { StartValue = 1222});
            engd.AddEntry(new LeaderEntry("Edward I", new int?[,] { { 1272, 1307 } }));
            engd.AddEntry(new LiteraryWorkEntry("Sentences", "Duns Scotus") {StartValue = 1300, Location = PrintLocation.Right});
            engd.AddEntry(new LeaderEntry("Edward II", new int?[,] { { 1307, 1327 } }) { StartValue = 1307});
            ...
            hre.AddEntry(new LeaderEntry("Henry IV", new int?[,] { { 1084, 1105 } }));
            hre.AddEntry(new LeaderEntry("Henry V", new int?[,] { { 1111, 1125 } }));
            hre.AddEntry(new LeaderEntry("Lothair III", new int?[,] { { 1133, 1137 } }));
            hre.AddEntry(new LeaderEntry("Frederick I", new int?[,] { { 1155, 1190 } }));
            hre.AddEntry(new LeaderEntry("Henry VI", new int?[,] { { 1191, 1197 } }));
            hre.AddEntry(new LeaderEntry("Otto IV", new int?[,] { { 1209, 1215 } }));
            hre.AddEntry(new LeaderEntry("Frederick II", new int?[,] { { 1220, 1250 } }));
            hre.AddEntry(1247, "Interregnum(1254-1273)");
            hre.AddEntry(new LeaderEntry("Henry VII", new int?[,] { { 1312, 1313 } }));
            hre.AddEntry(new LeaderEntry("Louis IV", new int?[,] { { 1328, 1347 } }));
            ...
            byz.AddEntry(new LeaderEntry("Alexios I", new int?[,] { { 1081, 1118 } }));
            byz.AddEntry(new LeaderEntry("John II", new int?[,] { { 1118, 1143 } }));
            byz.AddEntry(new LeaderEntry("Manuel I", new int?[,] { { 1143, 1180 } }) { StartValue = 1150});
            byz.AddEntry(1180, "Latins Massacred", PrintLocation.Right);
            byz.AddEntry(new LeaderEntry("Alexios II", new int?[,] { { 1180, 1183 } }) { StartValue = 1176 });
            byz.AddEntry(new LeaderEntry("Andronikos I", new int?[,] { { 1183, 1185 } }) { StartValue = 1182 });
            byz.AddEntry(new LeaderEntry("Isaac II", new int?[,] { { 1185, 1195 } }) { StartValue = 1091 });
            byz.AddEntry(new LeaderEntry("Alexios III", new int?[,] { { 1195, 1203 } }));
            byz.AddEntry(new LeaderEntry("Alexios IV & Isaac II", new int?[,] { { 1203, 1204 } }) { StartValue = 1200 });
            byz.AddEntry(new LeaderEntry("Theodore I", new int?[,] { { 1205, 1222 } }) { StartValue = 1218 });
            byz.AddEntry(new LeaderEntry("John III", new int?[,] { { 1222, 1254 } }) { StartValue = 1240 });
            byz.AddEntry(new LeaderEntry("Theodore II", new int?[,] { { 1254, 1258 } }));
            byz.AddEntry(new LeaderEntry("John IV", new int?[,] { { 1258, 1261 } }));
            byz.AddEntry(new LeaderEntry("Michael VII", new int?[,] { { 1259, 1282 } }) { StartValue = 1268});
            byz.AddEntry(new LeaderEntry("Andronikos II", new int?[,] { { 1282, 1328 } }));
            byz.AddEntry(new LeaderEntry("Andronikos III", new int?[,] { { 1328, 1341 } }));
            ...
            slj.AddEntry(new LeaderEntry("Suleyman", new int?[,] { { 1077, 1082 } }));
            slj.AddEntry(new LeaderEntry("Kilij Arslan", new int?[,] { { 1092, 1107 } }));
            slj.AddEntry(new LeaderEntry("Malik Shah", new int?[,] { { 1110, 1116 } }));
            slj.AddEntry(new LeaderEntry("Masud I", new int?[,] { { 1116, 1156 } }));
            slj.AddEntry(new LeaderEntry("Kilij Arslan II", new int?[,] { { 1156, 1192 } }));
            slj.AddEntry(1194, 1202, "wars of Ascension");
            slj.AddEntry(new LeaderEntry("Kaykhusraw I", new int?[,] { { 1205, 1211 } }));
            slj.AddEntry(new LeaderEntry("Kaykaus I", new int?[,] { { 1211, 1220 } }));
            slj.AddEntry(new LeaderEntry("Kayqubad I", new int?[,] { { 1220, 1237 } }));
            slj.AddEntry(new LeaderEntry("Kaykhusraw II", new int?[,] { { 1237, 1246 } }));
            ...
            mong.AddEntry(new LeaderEntry("Genghis", new int?[,] { { 1206, 1227 } }));
            mong.AddEntry(1215, "Battle of Zhongdu(1215)[N. China]");
            mong.AddEntry(1225, "Battle of Kalka R.(1223)[Ukraine][+]");
            mong.AddEntry(new LeaderEntry("Ogedei", new int?[,] { { 1229, 1241 } }));
            ...
            mong.AddEntry(new LeaderEntry("Guyuk", new int?[,] { { 1246, 1248 } }) { StartValue = 1248});
            mong.AddEntry(new LeaderEntry("Mongke", new int?[,] { { 1251, 1259 } }));
            mong.AddEntry(1265, "sack Hanio(1257)[Vietnam]");
            mong.AddEntry(new LeaderEntry("Kublai", new int?[,] { { 1260, 1294 } }));
            mong.AddEntry(1274, "Battle of Bun'ei(1274)[Japan]");
            mong.AddEntry(1281, "Battle of Koan(1281)[Japan]");
            mong.AddEntry(new LeaderEntry("Toghan Temur", new int?[,] { { 1333, 1370 } }));

            var ftd = new Block {Ruler = rule, Title = "Fatimid Caliphate", EndValue = 1171};
            ftd.AddEntry(new LeaderEntry("Abul-Qasim", new int?[,] { { 1094, 1101 } }) {StartValue = 1078});
            ftd.AddEntry(new LeaderEntry("Abu Ali", new int?[,] { { 1101, 1130 } }));
            ftd.AddEntry(new LeaderEntry("Abul-Maymun", new int?[,] { { 1130, 1149 } }));
            ftd.AddEntry(new LeaderEntry("Abu Mansur", new int?[,] { { 1149, 1154 } }));
            ftd.AddEntry(new LeaderEntry("Abul-Qasim", new int?[,] { { 1154, 1160 } }));
            ftd.AddEntry(new LeaderEntry("Abu Muhammad", new int?[,] { { 1160, 1171 } }));

            var ayy = new Block {Ruler = rule, Title = "Ayyubid Sultanates", StartValue = 1171, EndValue = 1260};
            ayy.AddEntry(new LeaderEntry("Saladin", new int?[,] { { 1174, 1193 } }));
            ...
            fr.AddEntry(new LeaderEntry("Phillip I", new int?[,] { { 1052, 1108 } }) {StartValue = 1096});
            fr.AddEntry(new LeaderEntry("Louis VI", new int?[,] { { 1108, 1137 } }));
            fr.AddEntry(new LeaderEntry("Louis VII", new int?[,] { { 1137, 1180 } }));
            fr.AddEntry(new HeresyEntry("Cathars", "duality") {StartValue = 1167});
            fr.AddEntry(new LeaderEntry("Phillip II", new int?[,] { { 1180, 1223 } }));
            fr.AddEntry(1209, "Cathar Crusade(1209-1229)");
            fr.AddEntry(new LeaderEntry("Louis VII", new int?[,] { { 1223, 1226 } }));
            fr.AddEntry(new LeaderEntry("Louis IX", new int?[,] { { 1226, 1270 } }));
            fr.AddEntry(new LeaderEntry("Philip III", new int?[,] { { 1270, 1285 } }));
            fr.AddEntry(new LeaderEntry("Philip IV", new int?[,] { { 1285, 1314 } }) );
            fr.AddEntry(new LeaderEntry("Louis X", new int?[,] { { 1314, 1316 } }));
            fr.AddEntry(new LiteraryWorkEntry("The Divine Comedy", "Dante") {StartValue = 1320});
            fr.AddEntry(new LeaderEntry("Philip V", new int?[,] { { 1316, 1322 } }) { StartValue = 1317});
            fr.AddEntry(new LeaderEntry("Charles IV", new int?[,] { { 1322, 1328 } }) { StartValue = 1325 });
            fr.AddEntry(new LeaderEntry("Philip VI", new int?[,] { { 1328, 1350 } }));
